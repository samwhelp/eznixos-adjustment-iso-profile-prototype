...
name="eznixos-adjustment-appearance-grub-theme-default"
gives="${name}"
pkgver="0.1"
pkgrel="1"
arch="all"
...
mod_theme_download () {
	...
	cp -rf "${srcdir}/grub-theme-remix-grub-theme-darkmatter-remix/." "${srcdir}/overlay/usr/share/grub/themes/default"
...
mod_theme_install () {
	...
	## * /usr/share/grub/themes/grub-theme-default
	##
