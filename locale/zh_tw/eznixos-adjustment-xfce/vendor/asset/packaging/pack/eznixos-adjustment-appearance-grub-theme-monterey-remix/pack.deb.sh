...
name="eznixos-adjustment-appearance-grub-theme-monterey-remix"
gives="${name}"
pkgver="0.1"
pkgrel="1"
arch="all"
...
mod_theme_download () {
	...
	wget -c "https://github.com/samwhelp/grub-theme-remix/archive/refs/heads/grub-theme-monterey-remix.tar.gz" -O "grub-theme-remix-grub-theme-monterey-remix.tar.gz"

	tar xf grub-theme-remix-grub-theme-monterey-remix.tar.gz

	cp -rf "${srcdir}/grub-theme-remix-grub-theme-monterey-remix/." "${srcdir}/overlay/usr/share/grub/themes/grub-theme-monterey-remix"
...
mod_theme_install () {
	...
	## * /usr/share/grub/themes/grub-theme-monterey-remix
	##
